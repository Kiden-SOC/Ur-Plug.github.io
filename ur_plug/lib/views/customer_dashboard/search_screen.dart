...
class _SearchScreenState extends State<SearchScreen> {
  ...
  final List<Map<String, dynamic>> _allProviders = [
    ...
    {'name': 'Namubiru Decorators', 'category': 'Event Decor', 'rating': '5.0', 'jobs': '19 jobs', 'icon': Icons.celebration},
  ];
        ...
        child: ListView(
          ...
          children: [
            ...
            ListTile(
              ...
              title: const Text('About / Account details', style: TextStyle(fontWeight: FontWeight.w600)),
              subtitle: const Text('Update profile, numbers, and info'),
              onTap: () {
...
class BookingHistoryScreenPlaceholder extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: const Center(child: Text('Past and active booking cards go here.')),
    );
  }
}
...
// Beautiful profile screen ready to show off for your presentation!
// REPLACE YOUR CODE WITH THIS COMPACT, Error-Free Version:
