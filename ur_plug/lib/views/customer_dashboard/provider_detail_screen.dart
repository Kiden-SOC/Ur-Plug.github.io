                ...
                children: [
                  const Row(
                    children: [
                      ...
                      SizedBox(width: 8),
                      Text('Smart Location Anchor', style: TextStyle(fontWeight: FontWeight.bold, fontSize: 14, color: brandPrimary)),
                    ],
                  ),
                  ...
                  const Text(
                    'Matched using Ur Plug recognizable proximity indexing.',
